...
def start(update, context):
    update.message.reply_text("Hello! Welcome Piyush's bot... ")

def helps(update, context):
    help_message = """
    Hi there, This Bot is Created By Piyush Agroya.
    How can I help you?...

    /start - To start the conversation
    /content - Information about This Bot and Owner.
    /contact - Information about contact of Piyush.
...
def content(update, context): 
    content_message = """
    This Bot is Created By Piyush Agroya. During the Vacation of Diwali...
...
def contact(update, context):
    ...
    GitHub: https://github.com/DevXPiyush
    """
